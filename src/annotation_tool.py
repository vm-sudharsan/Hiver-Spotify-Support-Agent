...
<div class="full"><label>Escalation reason codes</label><div id="reasons">''' + ''.join(f'<label style="display:inline-block;margin-right:12px;font-weight:normal"><input type="checkbox" value="{reason}"> {reason}</label>' for reason in REASON_CODES) + fr'''</div></div>
